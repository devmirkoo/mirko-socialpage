...
export default function LinkedTree() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-300 via-blue-400 to-blue-500 flex flex-col items-center justify-between p-4 overflow-hidden">
      <div className="w-full max-w-5xl flex flex-col md:flex-row items-center md:items-start space-y-8 md:space-y-0 md:space-x-8 flex-grow">
        <motion.div 
        ...
        >
          ...
          <h1 className="text-4xl font-bold text-white mb-2 text-center">My LinkedTree</h1>
          <p className="text-xl text-white opacity-80 text-center">Connect with me across the web</p>
        </motion.div>
